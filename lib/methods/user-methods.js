  ...
  */
  ...
  module.exports = UserMethods = (function() {
    ...
    */
    ...
    UserMethods.prototype.all = function(accountId, offset, count, cb) {
      var _this = this;
      if (offset == null) {
        offset = 0;
      }
    ...
    */
    ...
    UserMethods.prototype.getByName = function(accountId, name, cb) {
      var _this = this;
      if (cb == null) {
        cb = function() {};
      }
    ...
    UserMethods.prototype.getByPrimaryEmail = function(accountId, email, cb) {
      var _this = this;
      if (cb == null) {
        cb = function() {};
      }
    ...
    UserMethods.prototype.getByNameOrId = function(accountId, nameOrId, cb) {
      if (cb == null) {
        cb = function() {};
      }
    ...
    UserMethods.prototype.patch = function(accountId, usernameOrId, obj, actor, cb) {
      var _this = this;
      if (obj == null) {
        obj = {};
      }
    ...
    UserMethods.prototype["delete"] = function(accountId, usernameOrId, actor, cb) {
      var _this = this;
      if (cb == null) {
        cb = function() {};
      }
    ...
    UserMethods.prototype.destroy = function(accountId, usernameOrId, actor, cb) {
      var _this = this;
      if (cb == null) {
        cb = function() {};
      }
    ...
    UserMethods.prototype.setPassword = function(accountId, usernameOrId, password, actor, cb) {
      var _this = this;
      if (cb == null) {
        cb = function() {};
      }
    ...
    */
    ...
    UserMethods.prototype.findUserByUsernameOrEmail = function(accountId, usernameOrEmail, cb) {
      var _this = this;
      accountId = new ObjectId(accountId.toString());
    ...
    */
    ...
    UserMethods.prototype.validateUserByUsernameOrEmail = function(accountId, usernameOrEmail, password, cb) {
      var _this = this;
      accountId = new ObjectId(accountId.toString());
      usernameOrEmail = usernameOrEmail.toLowerCase();
    ...
    */
    ...
    UserMethods.prototype.create = function(accountId, objs, cb) {
      var user,
        _this = this;
      if (objs == null) {
        objs = {};
    ...
    */
    ...
    UserMethods.prototype.getOrCreateUserFromProvider = function(accountId, provider, v1, v2, profile, cb) {
    ...
    */
    ...
    UserMethods.prototype.resetPassword = function(accountId, email, cb) {
      var _this = this;
      if (cb == null) {
        cb = function() {};
      }
    ...
    UserMethods.prototype.resetPasswordToken = function(accountId, token, password, cb) {
      var userId,
        _this = this;
      if (cb == null) {
        cb = function() {};
