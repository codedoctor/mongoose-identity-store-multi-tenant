(function() {
  var ObjectId, PageResult, UserMethods, bcrypt, errors, isObjectId, mongoose, mongooseRestHelper, passgen, _,
  ...
  */
  ...
  module.exports = UserMethods = (function() {
    ...
    */
    ...
    UserMethods.prototype.all = function(accountId, options, cb) {
      var settings;
      if (options == null) {
        options = {};
      }
    ...
    */
    ...
    UserMethods.prototype.get = function(userId, options, cb) {
      ...
      if (!userId) {
        return cb(new Error("userId parameter is required."));
      }
    ...
    */
    ...
    UserMethods.prototype.getByUsernames = function(accountId, usernames, options, cb) {
      var query,
        _this = this;
      if (usernames == null) {
        usernames = [];
    ...
    */
    ...
    UserMethods.prototype.lookup = function(accountId, q, options, cb) {
      var r,
        _this = this;
      if (options == null) {
        options = {};
    ...
    UserMethods.prototype.getByName = function(accountId, name, options, cb) {
      var _this = this;
      if (options == null) {
        options = {};
      }
    ...
    UserMethods.prototype.getByPrimaryEmail = function(accountId, email, options, cb) {
      var _this = this;
      if (options == null) {
        options = {};
      }
    ...
    UserMethods.prototype.getByNameOrId = function(accountId, nameOrId, options, cb) {
      if (options == null) {
        options = {};
      }
      if (cb == null) {
    ...
    UserMethods.prototype.patch = function(accountId, usernameOrId, obj, options, cb) {
      var _this = this;
      if (obj == null) {
        obj = {};
      }
      ...
      accountId = new ObjectId(accountId.toString());
      return this.getByNameOrId(accountId, usernameOrId, function(err, item) {
        if (err) {
          return cb(err);
        }
        if (!item) {
        ...
        return item.save(function(err) {
          ...
          if (obj.password) {
            return _this.setPassword(accountId, usernameOrId, obj.password, {}, function(err, item2) {
              if (err) {
                return cb(err);
              }
              return cb(null, item);
    ...
    UserMethods.prototype["delete"] = function(accountId, usernameOrId, options, cb) {
      var _this = this;
      if (options == null) {
        options = {};
      }
    ...
    UserMethods.prototype.destroy = function(accountId, usernameOrId, options, cb) {
      var _this = this;
      if (options == null) {
        options = {};
      }
    ...
    UserMethods.prototype.setPassword = function(accountId, usernameOrId, password, options, cb) {
      var _this = this;
      if (options == null) {
        options = {};
      }
    ...
    */
    ...
    UserMethods.prototype.findUserByUsernameOrEmail = function(accountId, usernameOrEmail, options, cb) {
      var _this = this;
      if (options == null) {
        options = {};
      }
    ...
    */
    ...
    UserMethods.prototype.validateUserByUsernameOrEmail = function(accountId, usernameOrEmail, password, options, cb) {
      var _this = this;
      if (options == null) {
        options = {};
      }
      ...
      accountId = new ObjectId(accountId.toString());
      usernameOrEmail = usernameOrEmail.toLowerCase();
      return this.findUserByUsernameOrEmail(accountId, usernameOrEmail, function(err, user) {
        if (err) {
          return cb(err);
        }
        if (!user) {
    ...
    */
    ...
    UserMethods.prototype.create = function(accountId, objs, options, cb) {
      var user,
        _this = this;
      if (objs == null) {
        objs = {};
      ...
      */
      ...
      return this._hashPassword(objs.password, function(err, hash) {
        if (err) {
          return cb(err);
        }
        user.password = hash;
    ...
    */
    ...
    UserMethods.prototype.getOrCreateUserFromProvider = function(accountId, provider, v1, v2, profile, options, cb) {
    ...
    */
    ...
    UserMethods.prototype.resetPassword = function(accountId, email, options, cb) {
      var _this = this;
      if (options == null) {
        options = {};
      }
      ...
      return this.getByPrimaryEmail(accountId, email, function(err, user) {
        var newToken;
        if (err) {
          return cb(err);
        }
    ...
    UserMethods.prototype.resetPasswordToken = function(accountId, token, password, options, cb) {
      var userId,
        _this = this;
      if (options == null) {
        options = {};
      ...
      return this._hashPassword(password, function(err, hash) {
        if (err) {
          return cb(err);
        }
        return _this.models.User.findOne({
