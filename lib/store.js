(function() {
  var AdminMethods, EmailSchema, EntityMethods, OauthAccessGrantSchema, OauthAccessTokenSchema, OauthAppMethods, OauthAppSchema, OauthAuthMethods, OauthClientSchema, OauthRedirectUriSchema, OauthScopeMethods, OrganizationMethods, OrganizationSchema, RoleMethods, RoleSchema, Store, UserIdentitySchema, UserImageSchema, UserMethods, UserProfileSchema, UserSchema, mongoose, _;
  ...
  module.exports = Store = (function() {
    function Store(settings) {
      ...
      this.schemas = [UserSchema, UserIdentitySchema, UserImageSchema, UserProfileSchema, EmailSchema, OrganizationSchema, OauthAccessGrantSchema, OauthAccessTokenSchema, OauthAppSchema, OauthRedirectUriSchema, OauthClientSchema, RoleSchema];
      _ref = this.schemas;
