  ...
  */
  ...
  module.exports = UserMethods = (function() {
    ...
    */
    ...
    UserMethods.prototype.patch = function(accountId, usernameOrId, obj, actor, options, cb) {
      var _this = this;
      if (obj == null) {
        obj = {};
      }
    ...
    UserMethods.prototype["delete"] = function(accountId, usernameOrId, actor, options, cb) {
      var _this = this;
      if (options == null) {
        options = {};
      }
    ...
    UserMethods.prototype.destroy = function(accountId, usernameOrId, actor, options, cb) {
      var _this = this;
      if (options == null) {
        options = {};
      }
    ...
    UserMethods.prototype.setPassword = function(accountId, usernameOrId, password, actor, options, cb) {
      var _this = this;
      if (options == null) {
        options = {};
      }
