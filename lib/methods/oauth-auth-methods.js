  ...
  */
  ...
  module.exports = OauthAuthMethods = (function() {
    ...
    */
    ...
    OauthAuthMethods.prototype.createAccessGrant = function(appId, userId, redirectUrl, scope, realm, options, cb) {
      var accessGrant,
        _this = this;
      if (realm == null) {
        realm = null;
    ...
    */
    ...
    OauthAuthMethods.prototype.createOrReuseTokenForUserId = function(userId, clientId, realm, scope, expiresIn, options, cb) {
      if (options == null) {
        options = {};
      }
      if (cb == null) {
      ...
      return this.createTokenForUserId(userId, clientId, realm, scope, expiresIn, options, cb);
    };
    ...
    */
    ...
    OauthAuthMethods.prototype.createTokenForUserId = function(userId, clientId, realm, scope, expiresIn, options, cb) {
      var _this = this;
      if (realm == null) {
        realm = null;
      }
