(function() {
  ...
  module.exports = UserMethods = (function() {
    ...
    UserMethods.prototype.patch = function(accountId, usernameOrId, obj, options, cb) {
      ...
      accountId = new ObjectId(accountId.toString());
      return this.getByNameOrId(accountId, usernameOrId, (function(_this) {
        return function(err, item) {
          if (err) {
            return cb(err);
          }
    ...
    UserMethods.prototype.validateUserByUsernameOrEmail = function(accountId, usernameOrEmail, password, options, cb) {
      ...
      accountId = new ObjectId(accountId.toString());
      usernameOrEmail = usernameOrEmail.toLowerCase();
      return this.findUserByUsernameOrEmail(accountId, usernameOrEmail, (function(_this) {
    ...
    UserMethods.prototype.resetPassword = function(accountId, email, options, cb) {
      ...
      return this.getByPrimaryEmail(accountId, email, (function(_this) {
        return function(err, user) {
          var newToken;
          if (err) {
            return cb(err);
