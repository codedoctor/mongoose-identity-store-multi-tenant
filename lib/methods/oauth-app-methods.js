(function() {
  ...
  module.exports = OauthAppMethods = (function() {
    ...
    OauthAppMethods.prototype.create = function(accountId, objs, actor, options, cb) {
    ...
    OauthAppMethods.prototype.all = function(accountId, offset, count, options, cb) {
      var _this = this;
      if (offset == null) {
        offset = 0;
      }
      ...
      return this.models.OauthApp.count({
        accountId: accountId
    ...
    OauthAppMethods.prototype.getAppsForUser = function(owningUserId, offset, count, options, cb) {
      var _this = this;
      if (offset == null) {
        offset = 0;
      }
    ...
    OauthAppMethods.prototype.getApp = function(oauthAppId, options, cb) {
      var _this = this;
      if (options == null) {
        options = {};
      }
    ...
    OauthAppMethods.prototype["delete"] = function(oauthAppId, options, cb) {
      if (options == null) {
        options = {};
      }
      if (cb == null) {
    ...
    OauthAppMethods.prototype.deleteApp = function(oauthAppId, options, cb) {
      var _this = this;
      if (options == null) {
        options = {};
      }
    ...
    OauthAppMethods.prototype.update = function(oauthAppId, data, options, cb) {
      if (data == null) {
        data = {};
      }
      if (options == null) {
    ...
    OauthAppMethods.prototype.updateApp = function(oauthAppId, data, options, cb) {
      var _this = this;
      if (data == null) {
        data = {};
      }
