(function() {
  var OauthAuthMethods, ObjectId, PageResult, mongoose, mongooseRestHelper, passgen, _,
  ...
  */
  ...
  module.exports = OauthAuthMethods = (function() {
    ...
    */
    ...
    OauthAuthMethods.prototype.createAccessGrant = function(accountId, appId, userId, redirectUrl, scope, realm, options, cb) {
      var accessGrant,
        _this = this;
      if (realm == null) {
        realm = null;
    ...
    */
    ...
    OauthAuthMethods.prototype.createOrReuseTokenForUserId = function(accountId, userId, clientId, realm, scope, expiresIn, options, cb) {
      var _this = this;
      if (options == null) {
        options = {};
      }
      ...
      return this.appForClientId(clientId, function(err, app) {
        ...
        return _this.models.OauthAccessToken.findOne({
          ...
          return _this.createTokenForUserId(accountId, userId, clientId, realm, scope, expiresIn, options, cb);
        });
      });
    };
    ...
    */
    ...
    OauthAuthMethods.prototype.createTokenForUserId = function(accountId, userId, clientId, realm, scope, expiresIn, options, cb) {
      var _this = this;
      if (realm == null) {
        realm = null;
      }
